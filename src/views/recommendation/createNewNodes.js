...
export class CreateNewNodes extends Component {
    ...
    addNewNodesSibling() {
        ...
        if (nodeCollectionInputs.filter(ci => ci._id === "").length == 0) {
            this.setState({
                nodeCollectionInputs: [...this.state.nodeCollectionInputs, { _id: "***Your Collection ID ***", nodeInputs: [] }]
            })
        }
    }
