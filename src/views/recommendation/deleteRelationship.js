...
export class DeleteRelationship extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            react_method: "DeleteRelationship",
            reactString: "{}",
            contentString: "",
            collectionString: "",
            reactString: "{}",
            ...
            <CContainer>
                <CCard className="mb-4">
                    ...
                    <CCardBody className='m-1'>
                        ...
                        <CRow>
                            <CCol md={6}>
                                <CFormInput type="text" name="ids" value={this.state.collection.ids} placeholder="Seperate Collection IDs with comma(,)" onChange={this.idsChange.bind(this)} className="mx-1 mb-3" />
                            </CCol>
                        </CRow>
                        <CRow>
                            <CCol md={6}>
                                <CFormInput type="text" name="relationship" value={this.state.collection.relationship} placeholder="Relationship" onChange={this.rlsChange.bind(this)} className="mx-1 mb-3" />
                            </CCol>
                        </CRow>
                        <CRow>
