...
export class mobile_notification extends Component {
    handleOpenDialog = (e) => {
    ...
    handleOnFileLoad = (d) => {
        ...
        data.val.auth_key = d[0].data[0];
        data.val.content = d[1].data[0];
        data.val.title = d[2].data[0];
        data.val.topic = d[3].data[0];
        data.val.image = d[4].data[0];
        this.setState({
            data
        });
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            react_method: "SendMobileNotification",
            reactString: "{}",
            iosString: "[]"
        }
    }
    ...
    render() {
        return (
            <CContainer>
                <ToastContainer />
                <CCardHeader style={{ color: '#4f5d73', backgroundColor: "#fff" }} component="h5" className='p-2'>Mobile Notification</CCardHeader>
                ...
                <CCard>
                    <CCardBody>
                        <CRow>
                            ...
                            >
                                <span>Drop a CSV file contains notification info here or click to upload.</span>
                            </CSVReader>
                        </CRow>
                        <CRow>
                            ...
                            <CTabContent className='code_back p-3'>
                                <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={this.state.activeKey === 1}>
                                    <div>
                                        ...
                                        <CButton className='float-end mx-1' size='sm' component="a" href="./mobile_sample.csv" download="mobile_sample.csv" color='secondary'><CIcon icon={icon.cilCloudDownload} size="xs" />
                                    ...
                                    <div id="android">
                                        ...
                                        <pre className='code_void'>{"void "}<span className='code_void_name'>{"send_mobile_notification()"}</span><span>{"{\n"}</span></pre>
                                ...
                                <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={this.state.activeKey === 3}>
                                    ...
                                    <div id="react">
                                        ...
                                        <br />
                                        <pre><span className='import'>{"async "}</span><span className=''>{"sendMobileNotificationOnClickHandler() {\n"}</span></pre>
...
export default mobile_notification