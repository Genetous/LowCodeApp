...
export class DBJobMobileNotification extends Component {
                    ...
                    <CTabContent className='code_back p-3'>
                        <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={this.state.activeKey === 1}>
                            ...
                            <div id="android">
                                ...
                                <pre className='code_void'>{"void "}<span className='code_void_name'>{"addMobileNotificationDBJob()"}</span><span>{"{\n"}</span></pre>
                        ...
                        <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={this.state.activeKey === 3}>
                            ...
                            <div id="react">
                                ...
                                <pre><span className='import'>{"async "}</span><span className=''>{"createMobileNotificationJobOnClickHandler() {\n"}</span></pre>
...
export default DBJobMobileNotification