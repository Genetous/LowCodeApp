                    ...
                    <CTabContent className='code_back p-3'>
                        <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={this.state.activeKey === 1}>
                            ...
                            <div id="android">
                                ...
                                <pre className='code_void'>{"void "}<span className='code_void_name'>{"delete_relation()"}</span><span>{"{\n"}</span></pre>
                        ...
                        <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={this.state.activeKey === 3}>
                            ...
                            <div id="react">
                                ...
                                <pre><span className='import'>{"async "}</span><span className=''>{"deleteRelationOnClickHandler() {\n"}</span></pre>

                                <pre className='px-5'>
                                    <span className='import'>{"const "}</span>{"deleteRelation = " + this.state.reactString + "\n\n"
                                    }
                                    <span className='await'>{"await "}</span>{"post(deleteRelation, Methods." + this.state.react_method + ").then("}<span className='import'>{"function "}</span>{"(result) {\n" +
                                        "   //result as JSON\n" +
                                        "}, err => {\n" +
                                        "   //error result\n" +
                                        "});"
